...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { first_name: @developer.first_name } }, as: :json
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { first_name: @developer.first_name } }, as: :json
    assert_response 200
  end
